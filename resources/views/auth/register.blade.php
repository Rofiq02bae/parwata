...
<div class="fixed inset-0 z-50 bg-gray-100 flex items-center justify-center md:p-6 overflow-y-auto">    
    <div class="bg-white w-full max-w-full md:max-w-6xl min-h-screen md:min-h-[650px] md:rounded-2xl md:shadow-2xl overflow-hidden flex flex-col md:flex-row my-auto">    
        <div class="w-full md:w-3/5 p-8 sm:p-12 flex flex-col justify-center items-center bg-white">    
            ...
            <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-2 text-center">Create new account</h2>
            <p class="text-gray-500 text-center mb-6 text-sm">Register to submit laptop service tickets</p>
            ...
            <form method="POST" action="{{ route('register') }}" class="w-full max-w-md lg:max-w-xl space-y-4">
                @csrf
            ...
            <p class="mt-6 text-sm text-gray-600 text-center">
                Already member? 
                <a href="{{ route('login') }}" class="text-blue-600 hover:underline font-bold">Log in</a>
            </p>
        </div>
